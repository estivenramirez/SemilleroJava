...
import com.semillerojava.demospring.config.ApplicationConfig;
import com.semillerojava.demospring.config.PersistenceConfig;
...
public class AppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	protected Class<?>[] getRootConfigClasses() {
		return new Class[] { ApplicationConfig.class,WebConfig.class, PersistenceConfig.class };
	}
